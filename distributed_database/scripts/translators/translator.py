...
class Translator:
    def __init__(self, this_robot, topic_name, msg_type):
        self.__du = du

        self.__counter = 0
        self.__topic_name = topic_name
        self.__robot_name = this_robot
    ...
    def translator_cb(self, data):
        ...
        try:
            ...
            rospy.logdebug(f"Hash insert - {self.__topic_name} - {answ_hash}")
            self.__counter += 1
...
if __name__ == "__main__":
    rospy.init_node("topic_translator", anonymous=True)
